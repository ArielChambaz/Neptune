...
try:
    ...
    print("Modèles IA non disponibles. Fonctionnement en mode démo.")
    HAS_AI_MODELS = False
...
try:
    ...
    print("Fonctionnalités audio non disponibles.")
    HAS_AUDIO = False
    ...
    def load_models(self):
        ...
        try:
            ...
            if model_path.exists():
                ...
                print("Modèle d'eau introuvable, ignore la segmentation.")
                self.nwsd = None
    ...
    def detect_persons(self, frame):
        ...
        if self.dfine is None or self.processor is None:
            if not hasattr(self, '_model_warning_shown'):
                print("Modèles D-FINE non chargés - aucune détection possible")
                print(f"   - D-FINE: {'✅' if self.dfine is not None else '❌'}")
                print(f"   - Processor: {'✅' if self.processor is not None else '❌'}")
